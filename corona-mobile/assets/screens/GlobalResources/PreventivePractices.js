  ...
  constructor(props) {
    ...
    this.state = {
      list: [
        ...
        { title: image2, body: ["text1", "text2", "text3"] },
        { title: image3, body: ["text1", "text2", "text3"] },
        { title: image4, body: ["text1", "text2", "text3"] },
        { title: image5, body: ["text1", "text2", "text3"] },
        { title: image6, body: ["text1", "text2", "text3"] }
      ]
    };
  }
