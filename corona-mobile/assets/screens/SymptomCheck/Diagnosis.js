...
export function Diagnosis({navigation, response, retakeSurvey}) {
  ...
  if (response == "") {
    ...
    <View style={boxStyles.container}>
          <Text style={styles.surveyQuestionText}>Based on your symptoms, we recommend utlizing the following knowledge resources:</Text>
            <View style={{ flexDirection: "row" }}>
              <View style={{ flex: 1 }}>
                <SurveyNavigationButton title={"Info Toolkit"} navigation={navigation} navigationName={"InformationalToolkit"} />
              </View>
              <View style={{ flex: 1 }}>
                <SurveyNavigationButton title={"Best Practices"} navigation={navigation} navigationName={"PreventativePractices"} />
              </View>
            </View>
      </View>
    </View>
