        ...
        body={
          <View>
            <Text style={styles.tosText}>
              Satvik Sethi built the Project Covid app as a Free app. This
              SERVICE is provided by Satvik Sethi at no cost and is intended for
              use as is.
            </Text>
            <Text style={styles.tosText}>
            ...
            <Text style={styles.tosText}>
              ...
              our Terms and Conditions, which is accessible at Project Covid
            ...
            <Text style={styles.tosText}>
              ...
              information, including but not limited to location, symptoms, and
              push notifications. The information that I request will be
            ...
            <Text style={styles.tosText}>
              ...
              please contact me so that I will be able to do the necessary
              actions.
            </Text>
            ...
            <Text style={styles.tosText}>
              ...
              do not hesitate to contact me at satvik@runawayapp.com.
            </Text>
          </View>
        }
      />
        ...
        body={
          <View>
            <Text style={styles.tosText}>
              ...
              property rights related to it, still belong to Satvik Sethi.
            </Text>
            <Text style={styles.tosText}>
              Satvik Sethi is committed to ensuring that the app is as useful
            ...
            <Text style={styles.tosText}>
              You should be aware that there are certain things that Satvik
              Sethi will not take responsibility for. Certain functions of the
              ...
              provider, but Satvik Sethi cannot take responsibility for the app
            ...
            <Text style={styles.tosText}>
              Along the same lines, Satvik Sethi cannot always take
              ...
              and you can’t turn it on to avail the Service, Satvik Sethi cannot
              accept responsibility.
            </Text>
            <Text style={styles.tosText}>
              With respect to Satvik Sethi’s responsibility for your use of the
              ...
              to us so that we can make it available to you. Satvik Sethi
            ...
            <Text style={styles.tosText}>
              ...
              download the updates if you want to keep using the app. Satvik
              Sethi does not promise that it will always update the app so that
