        ...
        body={
          <View>
            ...
            <Text style={styles.tosText}>
              ...
              push notifications. The information that we request will be
            ...
            <Text style={styles.tosText}>
              ...
              13 has provided me with personal information, we will immediately
            ...
            <Text style={styles.tosText}>
              ...
              do not hesitate to contact us at info@LFRInternational.org.
            </Text>
          </View>
        }
      />
        ...
        body={
          <View>
            <Text style={styles.tosText}>
              ...
              property rights related to it, still belong to Satvik Sethi, Will
              Hunter, and LFR International.
            </Text>
            <Text style={styles.tosText}>
            ...
            <Text style={styles.tosText}>
              The Project Covid app stores and processes personal data that you
            ...
            <Text style={styles.tosText}>
              ...
              International will not take responsibility for. Certain functions
              of the app will require the app to have an active internet
              connection. The connection can be Wi-Fwe or provided by your
              mobile network provider, but LFR International cannot take
            ...
            <Text style={styles.tosText}>
              With respect to LFR International's responsibility for your use of
              ...
              to us so that we can make it available to you. LFR International
            ...
            <Text style={styles.tosText}>
              ...
              International does not promise that it will always update the app
